...
@login_required
def handle_admin_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
...
@login_required
def handle_budget_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
...
@login_required
def handle_cashier_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
...
@login_required
def handle_hrmu_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
...
# ACTION RECEIVE BUTTON FOR ICT OFFICE
@app.route('/ict_receive_document/<int:doc_no>', methods=['POST'])
@login_required
def handle_ict_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
...
@login_required
def handle_legal_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
...
@login_required
def handle_supply_receive_document(doc_no):  # Renamed the function
    conn = get_db_connection()
    cursor = conn.cursor()
